...
const dict = {
  zh: {
    ...
    'ext.s3Gallery.name': 'S3 图床相册',
    'ext.s3Gallery.author': '作者：flyMD',
    'ext.s3Gallery.desc': '查看并管理通过内置 S3/R2 图床上传的图片，支持复制链接、插入当前文档以及删除远端对象，集中管理你的图床资源。',
  ...
  en: {
    ...
    'ext.s3Gallery.name': 'S3 Image Gallery',
    'ext.s3Gallery.author': 'By: FlyMD',
    'ext.s3Gallery.desc': 'Browse and manage images uploaded via the built-in S3/R2 uploader, with support for copying links, inserting into the current document and deleting remote objects.',
    ...
    'ext.builtin.uploaderS3.name': 'Image Host (S3/R2)',
